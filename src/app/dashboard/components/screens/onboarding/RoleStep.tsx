...
export default function RoleStep({
  ...
  return (
    <>
      ...
      <div
        className={`mb-3 flex cursor-pointer items-center gap-3.5 rounded-[16px] border-[1.5px] border-ash-line bg-surface p-4 hover:border-thread ${role === "student" ? "border-thread bg-thread-soft" : ""}`}
        id="obRoleStudent"
      ...
      <div
        className={`mb-3 flex cursor-pointer items-center gap-3.5 rounded-[16px] border-[1.5px] border-ash-line bg-surface p-4 hover:border-thread ${role === "teacher" ? "border-thread bg-thread-soft" : ""}`}
        id="obRoleTeacher"
      ...
      <div
        className={`mb-3 flex cursor-pointer items-center gap-3.5 rounded-[16px] border-[1.5px] border-ash-line bg-surface p-4 hover:border-thread ${role === "school" ? "border-thread bg-thread-soft" : ""}`}
        id="obRoleSchool"
