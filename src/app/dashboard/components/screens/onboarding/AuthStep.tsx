...
export default function AuthStep({ onContinue }: { onContinue: () => void }) {
  return (
    <>
      ...
      <button
        className="mb-3 flex w-full cursor-pointer items-center justify-center gap-2.5 rounded-[14px] border-[1.5px] border-ash-line bg-surface px-3.25 py-3.25 text-[14px] font-bold text-ink hover:border-thread"
        onClick={() => onContinue()}
      >
