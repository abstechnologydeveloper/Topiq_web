...
export function Heatmap() {
  ...
  return (
    <>
      <div className="grid grid-cols-[120px_repeat(7,1fr)] gap-1.5 items-center mb-5">
        <div />
        {days.map((d, i) => (
        ...
        {subjects.map((s, i) => (
          <div key={s.id} className="contents">
            <div className="flex items-center gap-1.5 text-[11.5px] font-bold text-ash overflow-hidden">
