    ...
    <div>
      ...
      {editing && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40">
          <div className="w-full sm:max-w-[480px] bg-surface-50 rounded-[20px] sm:rounded-[20px] p-5 sm:p-6 max-h-[90vh] overflow-y-auto animate-in slide-in-from-bottom-4">
