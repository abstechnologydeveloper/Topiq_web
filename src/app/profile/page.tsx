    ...
    <div>
      ...
      {editing && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40">
          <div className="w-full sm:max-w-[480px] bg-surface-50 rounded-t-[20px] sm:rounded-[20px] max-h-[90vh] grid grid-rows-[auto_1fr_auto]">
            ...
            <div className="overflow-y-auto no-scrollbar p-5 sm:p-6 pt-0">
              {/* avatar picker */}
