...
export function CompetitionCard({ icon, name, level, desc, tags, entry }: Props) {
  return (
    <div className="bg-surface-50 border border-ash-line rounded-[--radius] p-4">
      ...
      <button className="bg-surface-900 text-surface-50 border-none px-4 py-[9px] rounded-[20px] font-bold text-[12.5px] cursor-pointer flex items-center gap-1.5 mx-auto">{entry} <ArrowRight size={12} /></button>
    </div>
  )
}
